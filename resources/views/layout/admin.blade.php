                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    ">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('posts.index') }}" class="nav-link {{ $routeName == 'posts.index' ? 'active' : '' }} ">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Danh sách bài viết</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('posts.create') }}" class="nav-link {{ $routeName == 'posts.create' ? 'active' : '' }} ">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Bài mới</p>
                                </a>
                            </li>
